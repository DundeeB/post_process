function [ b, M ] = M_frustration_post_proccess_for_lib(lib, plot_flag, N_realizations)
switch nargin
    case 3
        [b, M] = calc_M_frustration_for_lib(lib, N_realizations);
    case 2
        [b, M] = calc_M_frustration_for_lib(lib);
end
