...
switch nargin
    case 4
        [psi14, psi23] = psi_post_process_for_lib(lib, plot_flag, N_realizations);
%         [S45, Sm45, Sm_theta, k45, theta] = Bragg_post_process(lib, plot_flag, N_realizations);
        [b, M, N_sp] = M_frustration_post_proccess_for_lib(lib, plot_flag, N_realizations);
    case 3
        [psi14, psi23] = psi_post_process_for_lib(lib, plot_flag);
